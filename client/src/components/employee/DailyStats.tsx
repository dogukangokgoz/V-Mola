...
const DailyStats: React.FC<DailyStatsProps> = ({ dailyStats }) => {
  const progressPercentage = (dailyStats.totalMinutes / dailyStats.maxDailyMinutes) * 100;
  ...
  const getRemainingColor = () => {
    if (dailyStats.remainingMinutes <= 5) return 'text-danger-600';
    if (dailyStats.remainingMinutes <= 15) return 'text-warning-600';
    ...
    <div className="bg-white shadow rounded-lg">
      ...
      <div className="p-6">
        ...
        <div className="mt-4 p-3 rounded-lg bg-gray-50">
          ...
          ) : dailyStats.remainingMinutes <= 15 ? (
            <div className="flex items-center text-warning-700">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
